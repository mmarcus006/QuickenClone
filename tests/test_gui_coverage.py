...
# Setup basic widget mocks
for widget in ['QMainWindow', 'QDialog', 'QVBoxLayout', 'QHBoxLayout', 'QLabel', 
              'QComboBox', 'QPushButton', 'QFileDialog', 'QMessageBox', 'QLineEdit', 
              'QListWidget', 'QGroupBox', 'QDialogButtonBox', 'QWidget', 'QApplication']:
    setattr(mock_widgets, widget, MagicMock())
...
def setup_mocks():
    ...
    for widget in ['QMainWindow', 'QDialog', 'QVBoxLayout', 'QHBoxLayout', 'QLabel', 
                  'QComboBox', 'QPushButton', 'QFileDialog', 'QMessageBox', 'QLineEdit', 
                  'QListWidget', 'QGroupBox', 'QDialogButtonBox', 'QWidget', 'QApplication']:
        getattr(mock_widgets, widget).reset_mock()
...
def test_error_handling():
    ...
    gui.load_transactions()  # Should not raise exception

...
mock_widgets.QListWidget.return_value = MagicMock()
mock_widgets.QListWidget.return_value.currentRow = MagicMock(return_value=0)
mock_widgets.QComboBox.return_value = MagicMock()
mock_widgets.QComboBox.return_value.currentText = MagicMock(return_value="Buy")
mock_widgets.QLineEdit.return_value = MagicMock()
mock_widgets.QLineEdit.return_value.text = MagicMock(return_value="test")
mock_widgets.QLineEdit.return_value.isVisible = MagicMock(return_value=True)

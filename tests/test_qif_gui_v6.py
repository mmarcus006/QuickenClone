...
def gui(qt_application):
    """Create GUI instance"""
    with patch('PyQt6.QtWidgets.QMainWindow', spec=QMainWindow) as mock_main, \
         patch('PyQt6.QtWidgets.QDialog', spec=QDialog) as mock_dialog:
        gui = QIFConverterGUI()
...
def test_transaction_dialog():
    ...
    with patch('PyQt6.QtWidgets.QDialog', spec=QDialog) as mock_dialog:
